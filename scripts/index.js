...
const namePopupinput = popupWrraper.querySelector(
  ".popup__form-input_type_name"
);
const namePopupDiscription = popupWrraper.querySelector(
...
const popupContainerCloseBtn = popupEditCard.querySelector(
  ".popup__container-close"
);
const popupFormContainer = popupEditCard.querySelector(".popup__container");
const popupEditInputText = popupEditCard.querySelector(
  ".popup__form-input_type_text"
);
const popupEditInputLink = popupEditCard.querySelector(
